...
import tokan.matcha.utils.monotonic_align as monotonic_align
from tokan.matcha.models.baselightningmodule import BaseLightningClass
from tokan.matcha.models.components.flow_matching import CFM
from tokan.matcha.models.components.text_encoder import TextEncoder
...
class MatchaTTS(BaseLightningClass):  # 🍵
    ...
    def synthesise(self, x, x_lengths, n_timesteps, temperature=1.0, spks=None, cond=None, length_scale=1.0):
        ...
        decoder_outputs = self.decoder(
            mu_y, y_mask, n_timesteps, temperature, spks, cond, cfg_rate=self.inference_cfg_rate
        )
    ...
    def forward(self, x, x_lengths, y, y_lengths, spks=None, out_size=None, cond=None, durations=None):
        ...
        if self.training_cfg_rate > 0.0:
            cfg_mask = torch.rand(mu_y.shape[0], device=mu_y.device) > self.training_cfg_rate
            mu_y = mu_y * cfg_mask.view(-1, 1, 1)  # (B, D, T)

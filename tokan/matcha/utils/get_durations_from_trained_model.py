...
from tokan.utils.logging_utils import pylogger
from tokan.matcha.cli import get_device
from tokan.matcha.data.text_mel_datamodule import TextMelDataModule
from tokan.matcha.models.matcha_tts import MatchaTTS
from tokan.matcha.utils.utils import get_phoneme_durations
...
def main():
    ...
    with initialize(version_base="1.3", config_path="../../../configs/matcha/data"):
